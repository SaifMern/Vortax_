...
const Contact = () => {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      _subject: 'New Contact Form Submission (VortaxStudio)',
      _captcha: 'false',
    }
      ...
      <section className="relative overflow-hidden bg-brand-dark pt-32 text-white sm:pt-40">
        ...
        <div className="container-custom relative pb-20">
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-xs uppercase tracking-widest text-brand-orange">
        ...
        <div className="container-custom grid gap-10 lg:grid-cols-[0.82fr_1.18fr]">
          ...
          <div className="rounded-[2rem] bg-white p-8 shadow-card">
            ...
            <button
              ...
              className="mt-6 flex items-center gap-2 rounded-full bg-brand-orange px-6 py-3 text-white"
            >
